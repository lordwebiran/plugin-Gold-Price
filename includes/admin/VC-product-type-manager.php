...
class VC_product_type_manager
{
    ...
    public function __construct()
    {
        global $wpdb;
        $this->wpdb = $wpdb;
        $this->table = $this->wpdb->prefix . 'VCG_product_type';
    }
    ...
    public function page()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            // اضافه کردن
            if (isset($_POST['add_product_type_nonce'])) {
                if (!isset($_POST['add_product_type_nonce']) && !wp_verify_nonce($_POST['add_product_type_nonce'], 'add_product_type')) {
                    exit('sorry');
                }
                ...
                if ($insert) {
                    VC_Flash_Message::add_message('دپارتمان با موفقیت ایجاد');
                }
            }
    ...
    private function mine()
    {
        ...
        require_once G_admin_views_DIR . 'product-type/mine.php';
    }
